...
export async function CreateRegisterService({ data, deps }: CreateRegisterServiceParams) {
  ...
  const { password: _, ...registerOperatorWithoutPassword } = newRegister.operator
